...
public class RoleController {
    ...
    @Operation(summary = "List active roles with pagination", description = "Retrieves a paginated list of active roles. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "List all roles including inactive", description = "Retrieves a paginated list of all roles. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get roles by status", description = "Retrieves a paginated list of roles filtered by status. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get role by ID", description = "Retrieves detailed information of a single role. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Create a new role", description = "Creates a new role. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update an existing role", description = "Updates an existing role. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete a role", description = "Soft deletes a role by ID. Requires ADMINISTRADOR role.")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Role deleted successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Forbidden - User does not have privileges or trying to delete ADMINISTRADOR"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Role not found"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "500", description = "Internal server error")
    })
    @DeleteMapping("/{id}")
